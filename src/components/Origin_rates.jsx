...
export const getRatesByPortAndLine = async (por, shippingLine, containerType, pol) => {
  ...
  try {
    ...
    console.log(`Searching for rates with POR: ${por}, POL: ${pol}, Shipping Line: ${shippingLine}, Container: ${containerType}`);
    ...
    if (matchedRate) {
      ...
      return {
        ...
        ihc: `${currency}${matchedRate.ihc || "0"}`
      };
    } else {
